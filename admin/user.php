...
<head>
  ...
  <title>
    Hai ! <?=$_SESSION['username'];?> , Selamat datang
  </title>
  <!-- Favicon -->
...
">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <a class=" nav-link active " href=" ./user.php"> <i class="ni ni-tv-2 text-primary"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./mahasiswa/data.php">
              <i class="ni ni-circle-08 text-red"></i> Profile Kamu!
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./mahasiswa/dataguru.php">
              <i class="ni ni-single-02 text-yellow"></i> Guru Kamu!
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./mahasiswa/datajadwal.php">
              <i class="ni ni-book-bookmark text-purple"></i> Pengumuman!
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./mahasiswa/dataruangan.php">
              <i class="ni ni-building text-green"></i> Ruangan Kamu
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./mahasiswa/datamapel.php">
              <i class="ni ni-single-copy-04 text-red"></i> Mapel Kamu
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./mahasiswa/datanilai.php">
              <i class="ni ni-hat-3 text-blue"></i> Nilai Kamu!
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./mahasiswa/datakontrak.php">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h1 mb-0 text text-white text-capitalize d-none d-lg-inline-block" href="./user.php" style="font-family:montserrat,sans serif !important; font-size:35px;">Dashboard.</a>
        <!-- Form -->
            ...
            <div class="col-xl-3 col-lg-6" data-aos="fade-left" data-aos-duration="2000">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-capitalize text-muted mb-0">Temanmu!</h5>
            ...
            <div class="col-xl-3 col-lg-6" data-aos="fade-left" data-aos-duration="1900">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-capitalize text-muted mb-0">Guru Kamu!</h5>
            ...
            <div class="col-xl-3 col-lg-6"data-aos="fade-left" data-aos-duration="1800">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-capitalize text-muted mb-0">Ruangan Kamu!</h5>
                      <span class="h2 font-weight-bold mb-0">
                      <?php
                      include "../koneksi.php";
            ...
            <div class="col-xl-3 col-lg-6"data-aos="fade-left" data-aos-duration="1700">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-capitalize text-muted mb-0">Mapel Kamu!</h5>
                      <span class="h2 font-weight-bold mb-0">
                      <?php
                      include "../koneksi.php";
            ...
            <div class="col-xl-4 col-lg-6"data-aos="fade-left" data-aos-duration="1600">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-capitalize text-muted mb-1">User Page</h5>
                  ...
                  <p class="mt-1 mb-0 text-muted text-sm">
                   <a href="mahasiswa/data.php"> <span class="text-nowrap">Klik Disini</span></a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-lg-6"data-aos="fade-left" data-aos-duration="1500">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-1 mb-0 text-muted text-sm">
                   <a href="mahasiswa/dataguru.php"> <span class="text-nowrap">Klik Disini</span></a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-lg-6"data-aos="fade-left" data-aos-duration="1400">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-1 mb-0 text-muted text-sm">
                   <a href="mahasiswa/dataruangan.php"> <span class="text-nowrap">Klik Disini</span></a>
                  </p>
                </div>
              </div>
              <br>
            ...
            <div class="col-xl-6 col-lg-6"data-aos="fade-left" data-aos-duration="1300">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-1 mb-0 text-muted text-sm">
                   <a href="mahasiswa/datamapel.php"> <span class="text-nowrap">Klik Disini</span></a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6"data-aos="fade-left" data-aos-duration="1200">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-1 mb-0 text-muted text-sm">
                   <a href="mahasiswa/datajadwal.php"> <span class="text-nowrap">Klik Disini</span></a>
                  </p>
                </div>
              </div>
              <br>
            ...
            <div class="col-xl-6 col-lg-6"data-aos="fade-left" data-aos-duration="1200">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-1 mb-0 text-muted text-sm">
                   <a href="mahasiswa/datanilai.php"> <span class="text-nowrap">Klik Disini</span></a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6"data-aos="fade-left" data-aos-duration="1200"  >
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-1 mb-0 text-muted text-sm">
                   <a href="mahasiswa/datakontrak.php"> <span class="text-nowrap">Klik Disini</span></a>
                  </p>
                </div>
              </div>
            </div>
