      ...
      <div class="row">
        <div class="col">
          <div class="card shadow">
            ...
            <a data-toggle="modal" data-target="#exampleModalCenter"><h1 class="mb-0 btn btn-block bg-gradient-blue text-white"style="font-family:montserrat; font-size:40px;">Tambah Kontrak Disini.</h1></a>
            </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="editkontrak.php?id=<?php echo$d['id'];?>">Edit</a>
                          <a class="dropdown-item" href="deletekontrak.php?id=<?php echo$d['id'];?>">Hapus</a>
                        </div>
                      </div>
                    </td>
                  </tr>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <input class="form-control" list="siswa" size="50" type="text" id="nis" onkeyup="autofills()" required name="nis" placeholder="Cari NIS .." aria-label="Search">
